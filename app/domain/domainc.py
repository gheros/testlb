...
class domain:
    ...
    def insert(self,param):
        ...
        if bb is not None:return param+'该域名已存在'
    ...
    def scan():
        ...
        a=con('select sname,lname from blacklist')
        #查看客户数据
        return a
    ...
    def check(self,param):
        ...
        for a in aa:
            for b in bb:
                if a is not None and b is not None:return (param+'存在该域名')
...
#测试方法
#test=search('/home/edward/fileconf/tw_xjproxy/')
...
# print(domain('mgyx').insert('aaa'))
# print(domain('mgyx').delete('mgmgmg.cc'))
# print(domain('mgyx').insert('aomenbocaigongsi.cc'))
